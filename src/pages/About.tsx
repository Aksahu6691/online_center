						...
						<div>
							...
							<div className="text-slate-gray">
								<p className="my-4">
									...
									individuals. Our team of experts works tirelessly to provide innovative and high-quality services that
									cater to your needs.
								</p>
								<p className="my-4">
									With years of experience in the industry, we take pride in our ability to adapt to the latest trends
									and technologies, ensuring that our clients receive nothing but the best.
								</p>
								<p className="my-4">
									We believe in integrity, creativity, and excellence, and our mission is to help you achieve your goals
